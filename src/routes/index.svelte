...
<section id="about">
	<FlyUp top={-300} options={{ y: 200, duration: 1000, delay: 100 }}>
		<h2>
		...
		<div class="row 5a justify-content-center">
			...
			<div class="col-5">
				<FlyUp top={-300} options={{ y: 200, duration: 1000, delay: 300 }}>
					<p>
...
<script>
	...
	import FlyUp from '../components/helpers/FlyUp.svelte';
